...
if(offset < 0) redirect(301,pathname)
  ...
  const resp = fetch(`https://pokeapi.co/api/v2/pokemon?limit=10&offset=${offset}`);
  const data = (await (await resp).json()) as unknown as PokemonListResponse;
  ...
  return (
    <>
      <div class='flex flex-col'>
        ...
        <span>Offset: {location.isNavigating ? 'Si': 'No'}</span>
        <span>Se esta cargando la pagina</span>
      </div>
      <div class="mt-10">
